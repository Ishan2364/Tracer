"""Runner for eval/eval_v2_cases.md's 15 cases. Executes each case's turns through
answer_conversational() with a fresh ConversationState per case, saves raw,
untouched output to eval/results_v2/raw/{case_id}.json. Scoring/judgment is done
separately (manually, against eval_v2_cases.md's expected answers) - this script
...
RAW_DIR = EVAL_DIR / "results_v2" / "raw"
